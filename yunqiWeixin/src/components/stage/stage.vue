...
const stageImg1 = true;
const stageImg2 = false;
const stageImg3 = false;
const stageImg4 = false;
const stageImg5 = false;
const stageImg6 = false;
const stageImg7 = false;
const stageImg8 = false;
</script>
