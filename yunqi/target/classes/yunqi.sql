...
(
    ...
    `totalShip`        varchar(45) DEFAULT NULL,
    `installNumber`    varchar(45) DEFAULT NULL,
    `debugNumber`      varchar(45) DEFAULT NULL,
    `notInstalled`     varchar(45) DEFAULT NULL,
    `unregulated`      varchar(45) DEFAULT NULL,
    `createName`       varchar(45) DEFAULT NULL,
    `createTime`       datetime    DEFAULT NULL,
    `updateName`       varchar(45) DEFAULT NULL,
    `updateTime`       datetime    DEFAULT NULL,
